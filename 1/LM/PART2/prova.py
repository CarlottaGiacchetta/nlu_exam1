...
hid_size_emb_size = ((300,300),(600,600))
lr_list = [5, 10, 15]
clip = 5 # Clip the gradient
n_epochs_list = [30, 50, 100]
patience_list = [3, 6] #è il numero di epoche di tolleranza dopo le quali si interrompe l'addestramento se non c'è miglioramento
        ...
        for hidemb in hid_size_emb_size:
            ...
            for patient in patience_list:
                for n_epochs in n_epochs_list:
                    ...
                    path_saveresults = os.path.join('LM','PART2','RISULTATI3', f"{count}.csv")
                    count += 1
                    patience = 6
                    ...
                    with open(path_saveresults, mode='w', newline='') as file_csv:
                        ...
                        #csv_writer.writerow(['Model', f'{model}'])
                        ...
                        csv_writer.writerow(['test perplexity', f'{final_ppl}'])
